      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1>Our Location</h1>
            <p>We provide plumbing service for residential units, commercial units etc. Below is the locations we cover.<br/><br/>Click <a href='#contact' style="color:#212529">HERE</a> to make an appointment.</p>
