...
<?
	session_start();
	$db="";
	$session_pfx = "catmgr_landscaping";
	$site_name = ($site_name=="" ? "Landscaping Service":$site_name);
	$site_title = ($site_title=="" ? "Landscaping Service":$site_title); 
	$site_keyword = ($site_keyword=="" ? "Gardener Service in Malaysia, Garden Landscaping Service in Malaysia, Flower Planting and Flower Supply Service in Malaysia, Garden Pond, Garden Sculpture and Garden Fountain Installation in Malaysia":$site_keyword);
	$site_description = ($site_description=="" ? "Do you need a Landscaping Service? Landscaping Service is always your first choice. We provide <?=$site_keyword?> which our work is efficiency and quality. Contact Landscaping Service if you need a landscaping service.":$site_description); 
 
	$company_name = "Landscaping Service";
	// $site_url = "";	//without www.
	// $site_email = "";
	// $mailsender = "";
	$site_email = "woeishiuan98@gmail.com";
	$mailsender = "noreply@landscaping-service.com.my";
	$site_url = "http://rubyss.com/landscaping/";
   ...
   // RECAPTCHA SETTINGS
     ...
     $key = '6LciUKEUAAAAAOliFnOFMWPVtvEC_h_mIBOxAyjm';
